...
namespace Orthanc
{
    namespace Logging
    {
        ...
        static std::string logTargetFolder_;
        static std::string logTargetFile_;
        ...
        void SetCategoryEnabled(LogLevel level, LogCategory category, bool enabled)
        {
...
namespace
{
    struct LoggingStreamsContext
    {
        ...
        LoggingStreamsContext() : error_(&std::cerr),
                                  warning_(&std::cerr),
                                  info_(&std::cerr)
        {
        }
...
namespace Orthanc
{
    namespace Logging
    {
        ...
        InternalLogger::InternalLogger(LogLevel level,
                                       LogCategory category,
                                       const char *file,
                                       int line) : lock_(loggingStreamsMutex_, boost::defer_lock_t()),
                                                   level_(level),
